...
"Password=Cedric1234%%");
    ...
    private Applicants theApplicants;

    public Applicants set_Applicant(int id, string name, string lastname)
    {
        theApplicants = Applicants(int id, string name, string lastname);
    }


    public Applicants get_Applicant(string)
    {
